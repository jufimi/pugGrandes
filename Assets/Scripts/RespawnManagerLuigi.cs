...
public class RespawnManagerLuigi : MonoBehaviour
{
    public Transform respawnPoint;  // Punto de reaparición
    public GameObject playerPrefab; // Prefab del jugador Luigi
    ...
    public void RespawnPlayer()
    {
        ...
        {
            // Instancia una nueva copia del jugador Luigi en el punto de reaparición
